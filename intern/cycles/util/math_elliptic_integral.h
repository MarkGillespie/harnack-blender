...
double elliptic_em(double m, double errtol = 1.0E-3);
...
double elliptic_fm(double m, double errtol = 1.0E-3);
...
double elliptic_pim(double n, double m, double errtol = 1.0E-3);
