...
class GeometryManager {
 ...
 public:
  enum : uint32_t {
    ...
    POINT_ADDED = (1 << 12),
    POINT_REMOVED = (1 << 13),
    NONPLANAR_POLYGON_MESH_ADDED = (1 << 14),
    NONPLANAR_POLYGON_MESH_REMOVED = (1 << 15),

    SHADER_ATTRIBUTE_MODIFIED = (1 << 8),
    SHADER_DISPLACEMENT_MODIFIED = (1 << 9),

    GEOMETRY_ADDED = MESH_ADDED | HAIR_ADDED | POINT_ADDED | NONPLANAR_POLYGON_MESH_ADDED,
    GEOMETRY_REMOVED = MESH_REMOVED | HAIR_REMOVED | POINT_REMOVED |
                       NONPLANAR_POLYGON_MESH_REMOVED,
